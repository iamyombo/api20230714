                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    <a href="https://laravel-news.com"
                        ...
                        <div>
                            ...
                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Yombo Laravel News is a community driven portal and newsletter aggregating all of the
                                latest and most important news in the Laravel ecosystem, including new package releases
                                and tutorials.
                            </p>
                        </div>
